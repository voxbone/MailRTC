...
<head>
    ...
    <script src="https://webrtc.voxbone.com/js/jssip-0.7.9.min-vox.js" type="text/javascript"></script>
    <script src="https://webrtc.voxbone.com/js/voxbone-0.0.5.js" type="text/javascript"></script>
